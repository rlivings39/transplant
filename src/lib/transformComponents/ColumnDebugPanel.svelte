    ...
    {#if selectedColumn}
        <div class="column-details">
                        ...
                        <table>
                            ...
                            <tbody>
                                {#each selectedColumn.values.slice(0, 10) as value, index}
                                    <tr>
                                        <td>{index}</td>
                                        <td class={value === null ? 'null-value' : typeof value === 'string' ? 'string-value' : typeof value === 'number' ? 'number-value' : 'other-value'}>
                                            {formatValue(value)}
                                        </td>
            ...
            {#if selectedColumn.typeCoercion}
                <div class="property-section">
                    <button type="button" class="section-header" on:click={() => toggleSection('typeCoercion')}>
